...
If unspecified, the default is "eth1", which is the network adapter vagrant setup for private networking by default. So if you have set this option without making any advanced configuration, you should not need to specify a third argument, as shown in the example above.
